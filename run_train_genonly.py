...
from utils.convert_utils import save_to_hf_genonly
...
from transformers import LlamaConfig, LlamaTokenizer, LlamaModel, LlamaForCausalLM
...
from utils.train_utils import train_genonly
...
def main(**kwargs):
    ...
    # try:
    #     import wandb
    #     wandb_log = wandb.init(project="beyond_ntp")
    # except:
    wandb_log = None
    ...
    if train_config.resume_epoch>0:
        save_to_hf_genonly(train_config, resume_model_ckpt_path, kwargs, rank)
    ...
    if train_config.enable_fsdp and train_config.low_cpu_fsdp:
        ...
        if rank == 0:
            # model = LlamaForCausalLM(llama_config, train_config)
    ...
    save_to_hf_genonly(train_config, model_ckpt_path, kwargs, rank)
